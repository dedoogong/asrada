        ...
        while Count * 128 < I.shape[0]  :
            ...
            if Count % 256 == 0:
                ...
                if STAGE == 1 or STAGE == 0:
                    ...
                    TestErr = Sess.run(Ret_dict['S1_Cost'],{Feed_dict['InputImage']:Ti[RandomIdx2],Feed_dict['GroundTruth']:Tg[RandomIdx2],Feed_dict['S1_isTrain']:False,Feed_dict['S2_isTrain']:False})
