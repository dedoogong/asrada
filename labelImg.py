...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        openNextImg = action(getStr('nextImg'), self.openNextImg,
                             'v', 'next', getStr('nextImgDetail'))

        openPrevImg = action(getStr('prevImg'), self.openPrevImg,
                             'c', 'prev', getStr('prevImgDetail'))
        ...
        editMode = action('&Edit\nRectBox', self.setEditMode,
                          'Ctrl+F', 'edit', u'Move and edit Boxs', enabled=False)

        create = action(getStr('crtBox'), self.createShape,
                        'w', 'new', getStr('crtBoxDetail'), enabled=False)
        delete = action(getStr('delBox'), self.deleteSelectedShape,
                        'Shift+F', 'delete', getStr('delBoxDetail'), enabled=False)
        ...
        edit = action(getStr('editLabelShortcut'), self.editLabelShortcut,
                      'R', 'editshortcut', getStr('editLabelShortcutDetail'),
                      enabled=False)
