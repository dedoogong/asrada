...
class ColorHandPose3DNetwork(object):
    ...
    def init(self, session, weight_files=None, exclude_var_list=None):
        ...
        if exclude_var_list is None:
            ...
            exclude_var_list.append('PosePrior/conv_pose_0_1/biases')
            exclude_var_list.append('PosePrior/conv_pose_0_1/weights')
            exclude_var_list.append('PosePrior/conv_pose_0_2/biases')
            exclude_var_list.append('PosePrior/conv_pose_0_2/weights')
            exclude_var_list.append('PosePrior/conv_pose_1_1/biases')
            exclude_var_list.append('PosePrior/conv_pose_1_1/weights')
            exclude_var_list.append('PosePrior/conv_pose_1_2/biases')
            exclude_var_list.append('PosePrior/conv_pose_1_2/weights')
            exclude_var_list.append('PosePrior/conv_pose_2_1/biases')
            exclude_var_list.append('PosePrior/conv_pose_2_1/weights')
            exclude_var_list.append('PosePrior/conv_pose_2_2/biases')
            exclude_var_list.append('PosePrior/conv_pose_2_2/weights')
            exclude_var_list.append('PosePrior/fc_rel0/biases')
            exclude_var_list.append('PosePrior/fc_rel0/weights')
            exclude_var_list.append('PosePrior/fc_rel1/biases')
            exclude_var_list.append('PosePrior/fc_rel1/weights')
            exclude_var_list.append('PosePrior/fc_xyz/biases')
            exclude_var_list.append('PosePrior/fc_xyz/weights')

            exclude_var_list.append('ViewpointNet/conv_vp_0_1/biases')
            exclude_var_list.append('ViewpointNet/conv_vp_0_1/weights')
            exclude_var_list.append('ViewpointNet/conv_vp_0_2/biases')
            exclude_var_list.append('ViewpointNet/conv_vp_0_2/weights')
            exclude_var_list.append('ViewpointNet/conv_vp_1_1/biases')
            exclude_var_list.append('ViewpointNet/conv_vp_1_1/weights')
            exclude_var_list.append('ViewpointNet/conv_vp_1_2/biases')
            exclude_var_list.append('ViewpointNet/conv_vp_1_2/weights')
            exclude_var_list.append('ViewpointNet/conv_vp_2_1/biases')
            exclude_var_list.append('ViewpointNet/conv_vp_2_1/weights')
            exclude_var_list.append('ViewpointNet/conv_vp_2_2/biases')
            exclude_var_list.append('ViewpointNet/conv_vp_2_2/weights')

            exclude_var_list.append('ViewpointNet/fc_vp0/biases')
            exclude_var_list.append('ViewpointNet/fc_vp0/weights')
            exclude_var_list.append('ViewpointNet/fc_vp1/biases')
            exclude_var_list.append('ViewpointNet/fc_vp1/weights')

            exclude_var_list.append('ViewpointNet/fc_vp_ux/biases')
            exclude_var_list.append('ViewpointNet/fc_vp_ux/weights')
            exclude_var_list.append('ViewpointNet/fc_vp_uy/biases')
            exclude_var_list.append('ViewpointNet/fc_vp_uy/weights')
            exclude_var_list.append('ViewpointNet/fc_vp_uz/biases')
            exclude_var_list.append('ViewpointNet/fc_vp_uz/weights')

        import pickle

        if weight_files is None:
            #weight_files = ['./weights/handsegnet-rhd.pickle', './weights/posenet3d-rhd-stb-slr-finetuned.pickle']
            weight_files = ['./weights/posenet3d-rhd-stb-slr-finetuned.pickle']
    ...
    def inference(self, image, hand_side, evaluation):
        ...
        #print('Original image.get_shape : ',image.get_shape())
        ...
        return keypoints_scoremap
        #return image_crop, scale_crop, center, keypoints_scoremap, keypoint_coord3d
